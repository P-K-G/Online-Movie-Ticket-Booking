...
<article style="text-align: left;font-size:20px;COLOR:black;  background: #DCDCDC;" class="ticket">
         <header class="ticket__wrapper">
          <div class="ticket__header">
		     <p id="text"><div style="color:red; background-color:#F0F8FF; text-align:center;"><h2>Raj Mandir Cinema,Jaipur</h2></div></p> 
            
               <nav style="float:right;margin-right:-100px;margin-top:0px;">
			   ...
			   <div> <p>&nbsp&nbsp<b STYLE="COLOR:red;">Ticket NO. :-</b>12435</p><div>
           <?php 
$server = "localhost";
$usernam = "root";
$pass = "";
...
echo $i['Email'];
 ...
 <style>
      ...
      document.write( "<p style=color:red;>Raj Mandir Cinema</p>")
      document.write( "<p><b style=color:red;>Balcony <B style=COLOR:BLACK;>RS.120</B>Each</b></p>")
      var x= old.toString();
      document.write( "&nbsp&nbsp<b style=color:red;>Block <b style=color:black;>406</b>   Row<b style=color:black;> Q </b>  Seats no. </b>"+x)
      document.write( "&nbsp&nbsp<p>And</p>")
	  document.write( "&nbsp&nbsp<b style=color:red;>Your total seats are</b>"    +l+"\n")
      document.write( "&nbsp&nbsp<b style=color:red;>for a price of RS</b>"  +"\n"+l*ticketprice)
          ...
          <section class="ticket__section">
            <p>&nbsp&nbsp<b style="color:red;">Payment Method :-</b>Mastercard **** 8765</p>
          </section>
         </div>
         <footer class="ticket__footer">
          <span>&nbsp&nbsp<b style="color:red;">Total Paid :- </b></span>
          <script>
